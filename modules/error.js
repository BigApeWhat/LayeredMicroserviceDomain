...
module.exports = function ServiceError() {
    ...
    if (arguments.length === 1 && typeof (arguments[0]) === 'number') {
        chuck('Cannot provide status alone');
    }

    // Cause, message, status
    if (arguments.length === 3 && arguments[0] instanceof Error && typeof (arguments[1]) === 'string' && typeof (arguments[2]) === 'number') {
    ...
    // Message, status, type
    if (arguments.length === 3 && typeof (arguments[0]) === 'string' && typeof (arguments[1]) === 'number' && typeof (arguments[2]) === 'string') {
    ...
    // Cause, message
    if (arguments.length === 2 && arguments[0] instanceof Error && typeof (arguments[1]) === 'string') {
        this.cause = arguments[0];
        this.message = arguments[1];
        fixStack(this);
        return;
    ...
    // Cause, status
    if (arguments.length === 2 && arguments[0] instanceof Error && typeof (arguments[1]) === 'number') {
        this.cause = arguments[0];
